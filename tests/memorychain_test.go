...
func TestMemoryChainStorage_LastBlockRoundTrip(t *testing.T) {
	m := NewMemoryChainStorage()
...
func TestMemoryChainStorage_SaveIndexedEventDeduplicates(t *testing.T) {
	m := NewMemoryChainStorage()
	ctx := context.Background()
...
func TestMemoryChainStorage_SaveIndexedEventNilGuard(t *testing.T) {
	m := NewMemoryChainStorage()
...
func TestMemoryChainStorage_GetIndexedEventsFiltersAndSorts(t *testing.T) {
	m := NewMemoryChainStorage()
	ctx := context.Background()
...
func TestMemoryChainStorage_IsEventIndexed(t *testing.T) {
	m := NewMemoryChainStorage()
	ctx := context.Background()
...
func TestMemoryChainStorage_Close(t *testing.T) {
	m := NewMemoryChainStorage()
...
func TestMemoryChainStorage_ConcurrentAccessNoRace(t *testing.T) {
	m := NewMemoryChainStorage()
	ctx := context.Background()
